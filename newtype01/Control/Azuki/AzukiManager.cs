...
namespace NewType.Seeker.Control.Azuki
{
    ...
    public static class AzukiManager
    {
        ...
        private static List<string> LoadKeywordFile()
        {
            ...
            try
            {
                if (File.Exists(Application.StartupPath + @"\" + SQLKeywordFileName))
                {
                    XmlDocument doc = new XmlDocument();
                    doc.Load(Application.StartupPath + @"\" + SQLKeywordFileName);
